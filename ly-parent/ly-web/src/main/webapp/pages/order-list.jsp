		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="/order/plist"'>
									...
									<tr>
										...
										<td class="text-center">
											<button type="button" class="btn bg-olive btn-xs"
												onclick='location.href="/pages/order-update.jsp"'>修改</button>
											<button type="button" class="btn bg-olive btn-xs"
												onclick='location.href="/order/delete/${order.id}"'>删除</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="/order/list.shtml?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<li><a href="/order/list.shtml?page=${pageInfo.prePage}&size=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach items="${pageInfo.navigatepageNums}" var="p">
									<li><a href="/order/list.shtml?page=${p}&size=${pageInfo.pageSize}">${p}</a></li>
								</c:forEach>
							<li><a href="/order/list.shtml?page=${pageInfo.nextPage}&size=${pageInfo.pageSize}">下一页</a></li>
							<li><a href="/order/list.shtml?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
